...
# How strongly the has-answer head is penalised. 1.5 weights it slightly
# above the span loss, which helps on CUAD where negative examples dominate.
HAS_ANSWER_LOSS_WEIGHT = 1.5

# Max answer length in tokens (used at inference time, not in loss)
MAX_ANSWER_LEN = 150
